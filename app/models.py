...
class Post(db.Model):
    ...
    body_summary = db.Column(db.String(100))
    ...
    def generate_fake(count=100):
        ...
        for i in range(count):
            ...
            p = Post(title=forgery_py.lorem_ipsum.title(),body=forgery_py.lorem_ipsum.sentences(randint(1, 5)),
    ...
    def on_changed_body(target, value, oldvalue, initiator):
        ...
        target.body_summary =bleach.linkify(bleach.clean(target.body_html, tags=[], strip=True))[:97] + "..."
